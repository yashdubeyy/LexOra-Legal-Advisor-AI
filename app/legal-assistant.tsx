        ...
        <div className="container mx-auto px-4 py-10">
          ...
          >
            <div className="inline-block">
              ...
              >
                <ScaleIcon className="h-14 w-14 text-blue-800 mx-auto" />
              </motion.div>
            </div>
            <h1 className="text-5xl font-bold mt-4 text-blue-900">
            ...
            <div className={`mt-3 text-sm inline-flex items-center px-3 py-1 rounded-full ${apiStatus.isConnected ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'}`}>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            >
              <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-blue-100">
                <div className="bg-gradient-to-r from-blue-800 to-blue-600 p-6 flex items-center">
                ...
                <div className="p-6">
                  <div className="flex border-b mb-4">
                    <button
                      className={`px-4 py-2 text-sm font-medium ${activeTab === "issue" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500 hover:text-blue-600"}`}
                    ...
                    {result && (
                      <button
                        className={`px-4 py-2 text-sm font-medium ${activeTab === "analysis" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-500 hover:text-blue-600"}`}
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                          <div>
                            <textarea
                              ...
                              className="w-full h-64 p-4 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none transition duration-200"
                          ...
                          <div className="flex justify-end">
                            <motion.button
                              ...
                              whileTap={{ scale: 0.98 }}
                              type="submit"
                              className="bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-lg shadow-md flex items-center space-x-2 transition-colors"
                      ...
                      >
                        ...
                        <div className="flex justify-between mt-6">
                          ...
                          <motion.button
                            ...
                            className="bg-gray-100 hover:bg-gray-200 text-gray-800 font-medium px-4 py-2 rounded-lg flex items-center space-x-2"
                          >
                            <DocumentDuplicateIcon className="w-5 h-5" />
                      ...
                      <ul className="divide-y">
                        {ipcSections.map((section, index) => (
                          <motion.li 
                            ...
                            className="py-2"
                          >
                            <p className="font-medium text-blue-900">{section.section}</p>
                ...
                <div className="p-4">
                  <ol className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-sm">Describe your legal issue in detail</span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span className="text-sm">AI analyzes case details and identifies legal matters</span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span className="text-sm">System finds relevant IPC sections</span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span className="text-sm">Matches with legal precedents and similar cases</span>
                    </li>
                    <li className="flex items-start">
                      ...
                      <span className="text-sm">Generates appropriate legal documentation</span>
                    </li>
                  </ol>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-4 md:mb-0">
                <div className="flex items-center">
                  ...
                  <span className="font-bold text-lg">Personal Legal Assistant</span>
                </div>
              ...
              <div className="text-sm text-gray-400">
                <p>© {new Date().getFullYear()} Personal Legal Assistant</p>
